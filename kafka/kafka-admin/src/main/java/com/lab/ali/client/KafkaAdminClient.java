...
import com.lab.ali.exception.KafkaClientException;
...
public class KafkaAdminClient {
    ...
    private HttpStatus getSchemaRegistryStatus() {
        try {
            return webClient
                    ...
                    .exchange()
                    .map(org.springframework.web.reactive.function.client.ClientResponse::statusCode)
                    .block();
        } catch (Exception e) {
    ...
    private Collection<TopicListing> getTopics() {
        ...
        try {
            ...
            throw new com.lab.ali.exception.KafkaClientException("Reached max number of retry for reading kafka topic(s)!", t);
        }
        return topics;
    }
