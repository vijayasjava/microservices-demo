package com.lab.ali.kafkaconsumer.configuration;
...
@Data
@Configuration
public class KafkaConsumerConfiguration<K extends Serializable,
		V extends SpecificRecordBase> {

	private KafkaConfigData kafkaConfigData;
	private KafkaConsumerConfigData kafkaConsumerConfigData;
	
	public KafkaConsumerConfiguration(KafkaConfigData kafkaConfigData,
